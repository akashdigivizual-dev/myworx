      ...
      <Hero 
        ...
        breadcrumbs={
          <>
             ...
             <span>&gt;</span>
             <span className="text-brand-orange">Pankaj Rathi</span>
          </>
        }
      />
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="w-full lg:w-1/2">
              <h1 className="text-4xl lg:text-5xl font-extrabold text-gray-900 mb-2">Pankaj Rathi</h1>
