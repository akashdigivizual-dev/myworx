...
const bookMeetingRoomImage = new URL(
  "../assets/locations/book-meeting-room.jpg",
  import.meta.url
).href;
const background2 = new URL(
  "../assets/locations/background2.jpg",
  import.meta.url
).href;
  ...
  const serviceCards = [
    {
      ...
      description:
        "Complete GST registration support with professional business address, mail handling, call answering, and all necessary documentation. Establish your business presence with credibility and ease.",
    ...
    },
    {
      ...
      image: background2,
      description:
        "Everything you need for business registration in a virtual office setup. Get a prime business location, full documentation, in-office services, and all required compliance support without physical office expenses.",
    ...
    },
    {
      ...
      image: background2,
      description:
        "Maintain a professional mailing address in Noida without a physical office. We collect, store, scan, and forward your mail securely. Perfect for remote businesses, startups, and freelancers.",
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 md:gap-16 mb-16 md:mb-24">
            ...
            <div className="flex flex-col justify-center">
              ...
              <p className="text-gray-600 text-base leading-relaxed mb-8">
                Myworx provides flexible virtual office solutions starting from
                just ₹799/month. Establish your professional presence, get GST
                registered, handle business documentation, and manage mail
                efficiently - all from one integrated platform.
              </p>
            ...
            <div className="flex flex-col justify-center space-y-6">
              ...
              <p className="text-gray-600 text-base leading-relaxed">
                We provide comprehensive virtual office solutions tailored for
                startups, entrepreneurs, freelancers, and SMEs. From GST
                registration support to mail handling and business compliance,
                we handle the operational details so you can focus on growing
                your business.
              </p>
              <div className="space-y-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  />
                  <span className="text-gray-700">
                    Flexible packages with no long-term commitment
                  </span>
                </div>
              </div>
            </div>
              ...
              <table className="w-full bg-white border-collapse">
                <tbody>
                  ...
                  <tr className="border-b border-gray-200">
                    <td className="w-1/4 p-0 border-r border-gray-200">
                  ...
                  <tr className="border-b border-gray-200 hover:bg-gray-50">
                    ...
                    <td className="p-2 md:p-4 text-center border-r border-gray-200">
                    ...
                    <td className="p-2 md:p-4 text-center bg-primary/5">
                      <span className="text-primary text-xl md:text-2xl">
                        ✓
                      </span>
                    </td>
                  ...
                  <tr className="border-b border-gray-200 hover:bg-gray-50">
                    ...
                    <td className="p-2 md:p-4 text-center border-r border-gray-200">
                      <div>
                        <span className="text-primary text-xl md:text-2xl block">
                          ✓
                        </span>
                        <span className="text-xs text-gray-600 mt-1 md:mt-2">
                          (1 day hub access)
                        </span>
                      </div>
                    </td>
          ...
          <div className="bg-gradient-to-r from-primary/5 to-primary/10 border border-primary/10 rounded-lg p-8 md:p-16 mb-16 md:mb-24">
            ...
            <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              A virtual office is more than just an address. It's a complete
              business solution that helps you establish credibility, manage
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {features.map((feature, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="bg-white border border-gray-200 rounded-lg p-8 hover:shadow-lg transition-all duration-300 text-center"
                  >
          ...
          <div
            className="relative py-16 md:py-24 px-8 md:px-16 rounded-lg bg-cover bg-center mb-16 md:mb-24"
          ...
          >
            ...
            <div className="relative z-10 max-w-3xl mx-auto text-white">
              ...
              <p className="text-lg leading-relaxed mb-8">
                Join hundreds of startups, entrepreneurs, and businesses who
                trust Myworx for their virtual office needs. Get started in
                minutes with our flexible plans and comprehensive support.
              </p>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-700">
                  Avoid the overhead of renting physical office space. With
                  virtual office solutions starting at just ₹799/month, you get
                  a professional presence without the burden of managing a
                  physical location.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-700">
                  A professional business address and dedicated phone line
                  enhance your brand credibility. Clients and business partners
                  perceive you as an established, trustworthy business.
                </p>
              </div>
              <div>
                <h4 className="text-lg font-bold text-gray-900 mb-3">
                ...
                <p className="text-gray-700">
                  Let our team handle mail management, call answering, and
                  administrative tasks. You focus on core business activities
              ...
              <div>
                ...
                <p className="text-gray-700">
                  No long-term contracts. Upgrade or downgrade your plan anytime
                  as your business grows. Perfect for startups and businesses in
                  transition.
                </p>
              </div>
            </div>
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 md:p-12 mb-16 md:mb-24">
            ...
            <p className="text-gray-600 mb-8">
              Talk to our virtual office specialists and find the perfect plan
              for your business needs. No commitment required.
            </p>
            <ContactForm />
          </div>
