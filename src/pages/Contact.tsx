          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8">
              ...
              <div className="w-full h-96 bg-gray-200 rounded-xl overflow-hidden border border-gray-300">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3505.8527194!2d77.3081226!3d28.5850725!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390ce56e5243d7df%3A0x6c07b66dd4ebe6a5!2sMyworx%20Zone!5e0!3m2!1sen!2sin!4v1700000000000"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
              ...
              <div className="bg-gray-100 p-6 rounded-lg">
                ...
                <ul className="text-sm text-gray-700 space-y-2">
                  <li>
                    <strong>Monday - Saturday:</strong> 09:00 AM - 07:00 PM
                  </li>
                  <li>
      ...
      <section className="py-16 bg-gradient-to-r from-primary to-orange-600 text-white">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <p className="text-lg opacity-90 mb-8 max-w-2xl mx-auto">
            Join hundreds of satisfied professionals and businesses at Myworx.
