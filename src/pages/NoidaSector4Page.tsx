...
const img3 = new URL('../assets/locations/D99_Sector2.JPG', import.meta.url).href;
const img4 = new URL('../assets/locations/virtualspace.JPG', import.meta.url).href;
...
const NoidaSector4Page: React.FC = () => {
  const locationData = {
    ...
    galleryImages: [
      ...
      { src: img2, alt: 'office Space in Noida Sector 4' },
