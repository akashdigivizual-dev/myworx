  ...
  return (
    <footer id="contact" className="bg-brand-dark text-white pt-20 pb-10 text-sm">
      <div className="container mx-auto px-4 lg:px-8">
        {/* Mobile Footer - Reordered Sections */}
        <div className="lg:hidden block">
          <div className="grid grid-cols-1 gap-12 border-b border-gray-800 pb-16">
            {/* First: Head Office address and Call Us details */}
            <div>
            ...
            <div>
              ...
              <p className="text-gray-400 leading-relaxed text-xs">
                D-99, Sector -2 Ground floor ,Noida ,201301
              </p>
            </div>
            ...
            {/* Third: Useful Links (including My Worx Property) */}
            <div>
              ...
              <ul className="text-gray-400 text-xs space-y-2">
                ...
                <li><a href="/myworx-property" className="hover:text-brand-orange">My Worx Property</a></li>
