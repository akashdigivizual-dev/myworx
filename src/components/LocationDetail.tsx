...
import sector2Video from "../assets/video/sector_1.mp4";
          ...
          <div className="lg:col-span-2 space-y-8 md:space-y-12">
            ...
            <div>
              ...
              <p className="text-lg font-semibold text-gray-700 mb-4">
                A Space Designed for Inspiration and Success
              </p>
            </div>
            ...
            <div
              className="w-full bg-gray-300 rounded-lg overflow-hidden"
              style={{
                paddingBottom: "56.25%",
                position: "relative",
                height: 0,
            ...
            <div>
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">
                Best Coworking Space in {sector.split(",")[0]}
              </h3>
                ...
                {packages.map((pkg, idx) => (
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <a
                        href="/contact"
                        className="w-full bg-primary hover:bg-orange-600 text-white font-bold py-2 px-4 rounded text-center block transition"
                      >
                        Book Now
                      </a>
                    </div>
            ...
            <div className="bg-gray-50 p-8 rounded-lg">
              ...
              <p className="text-gray-600 mb-6">
                Book a private viewing and get a plan customized to your
                requirements
              </p>
              <a
                href="/contact"
                className="inline-block bg-primary hover:bg-orange-600 text-white font-bold py-3 px-8 rounded transition"
              >
                Schedule a Visit
              </a>
            </div>
              ...
              <div className="mt-8 space-y-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-2">
                    Coworking spaces are available in both day and night shifts.
                  </p>
                </div>
              </div>
            </div>
